module Redis::RedisKeys
  ...
  CAPTAIN_RESPONSE_SCHEDULE_TOKEN = 'CAPTAIN::RESPONSE_SCHEDULE::%<conversation_id>d'.freeze
  CAPTAIN_LAST_INCOMING_AT = 'CAPTAIN::LAST_INCOMING_AT::%<conversation_id>d'.freeze
