...
RSpec.describe Whatsapp::Wapi::DeviceService do
  ...
  describe '#create_device' do
    ...
    it 'raises WapiError on failure' do
      ...
      expect { service.create_device(device_id) }.to raise_error(CustomExceptions::WapiError, 'Device already exists')
    end
  end
  ...
  describe 'WapiError' do
    it 'is a StandardError subclass' do
      expect(CustomExceptions::WapiError.ancestors).to include(StandardError)
    end
  end
end
